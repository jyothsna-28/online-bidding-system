...
<div class="card-group">
  <?php
        $q = "SELECT * from bidding where suid = $uid";
        ...
        while($rows = $result->fetch_assoc()){
            ...
            if($pay==0){
            	...
            	<p class="card-text text1"><label class="pc">Bidded Price is '.$rows['price'].'</label></p> 
            	<button name="buy" class="btn btn-primary"><a href="selectAddress.php?bid='.$id.'">Pay now</a></button>
            	</div>';
            	echo '</div>';
            	echo '</div>';
            ...
            <p class="card-text"><h6>'.$rows['description'].'</h6></p>
            <p class="card-text text1"><label class="pc">Bidded Price is '.$rows['price'].'</label></p> 
            <button name="buy" class="btn btn-success"><a href="#">Paid</a></button>
            </div>';
            echo '</div>';
            echo '</div>';
