...
<div class="card-group">
  <?php
        ...
        while($rows = $result->fetch_assoc()){
            ...
            <p class="card-text text1"><label class="pc">Base Price is '.$rows['price'].'</label></p> 
            <p class="card-text text1"><b>'.(24-$hours).' hours left for bidding</b></p>
            <button name="buy" class="btn btn-primary"><a href="bidNow.php?bid='.$id.'">Bid now</a></button>
            </div>';
            echo '</div>';
            echo '</div>';
