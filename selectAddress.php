  ...
  <?php
       $uid = $_SESSION["uid"];
        ...
        while($rows = $result->fetch_assoc()){
            ...
            <p class="card-text text1"> <button  name="add" class="btn btn-primary" value="Select Address"><a href = "/webproject/confirmItem.php?aid='.$aid.'&bid='.$bid.'"><label class="addre">Select Address</label></a></button>
            </div>';
            echo '</div>';
            echo '</div>';
