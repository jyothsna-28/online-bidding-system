...
<div class="card-group">
  <?php
        $q = "SELECT * from bidding where uid = $uid";
        ...
        while($rows = $result->fetch_assoc()){
            ...
            <p class="card-text text1"><label class="pc" style="color:darkblue;">Bid Price As of now: '.$rows['price'].'</label></p> 
            <p class="card-text text1" style="color:green;"><b>Bidding Progressing</b></p>
            </div>';
            echo '</div>';
            echo '</div>';
              continue;
            ...
            <h5 class="card-title">'.$rows['itemname'].'</h5>
            <p class="card-text"><h6>'.$rows['description'].'</h6></p>
            <p class="card-text text1"><b><label class="pc" style="color:darkblue;">Bid Price As of now: '.$rows['price'].'</label></b></p> 
            <p class="card-text text1"><b>Bidding Completed</b></p>
            <button name="buy" class="btn btn-primary"><a href="finalBid.php?bid='.$id.'">View Bid Result</a></button>
            </div>';
            echo '</div>';
            echo '</div>';
