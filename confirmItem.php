      ...
      $uid = $_SESSION["uid"];
        ...
        while($rows = $result->fetch_assoc()){
          $price = $rows['price'];
            ...
            <p class="card-text text1"><label class="pc">Price is '.$price.'</label></p> <form action = "confirmBackenedBid.php" method = "post">
            <input type = "hidden" value = '."".$bid."".' name = "bid"><input type = "hidden" value = '."".$aid."".' name = "aid">
