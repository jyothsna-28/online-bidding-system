...
<body>
  <div class="login">
    ...
    <form method="post" action="loginController.php">
        <input type="text" name="email" placeholder="Username" required="required" /><span><?php echo $error1;echo $error3; ?></span><br><br>
    ...
    <a href="forgotPassword.php" class="btn btn-success btn-block btn-large" style="background-color: red;">Forgot Password?</a>
</div>
</body>
</html>